...
Lib.unpack_cursor = unpack_cursor
...
function Lib.build_ext (tag, data)
	return nil
end
...
local function unpack_ext (c, n, tag)
	...
	c.i = i+n
	return Lib.build_ext(tag, s:sub(i, e))
end
...
if SIZEOF_NUMBER == 4 then
	...
	if SIZEOF_NUMBER > 8 then
		Lib.long_double = true
	end
end
set_array'without_hole'

Lib._VERSION     = '0.5.2'
Lib._DESCRIPTION = "lua-MessagePack : a pure Lua implementation"
Lib._COPYRIGHT   = "Copyright (c) 2012-2019 Francois Perrad"
