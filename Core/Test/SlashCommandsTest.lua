    ...
    describe("functional", function()
        ...
        describe("bulk receive", function()
            ...
            it("invokes all", function()
                ...
                __WOW_Input('/r2d2x test 1 2 3')
                __WOW_Input('/r2d2x foo 9 8 6')
                assert.spy(onReceiveSpy).was_called(4)
