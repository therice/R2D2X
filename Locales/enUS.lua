...
L["auto_add_x_items"] =  "Auto Add %s Items"
...
L["auto_start"] = "Skip Session Setup"
L["auto_start_desc"] = "Skips the Loot Session Setup Interface. This results in a session starting with all eligible items without you having a chance to edit the list"
L["award"] = "Award"
L["awards"] = "Awards"
...
L["candidates_cannot_use"] = "Candidates that cannot use the item"
...
L["chat"] = "Chat"
L["chat version"] = "|cFF87CEFA" .. name .. "|r |cFFFFFFFFversion|r|cFFFFA500 %s|r"
...
L["chat_commands_metrics"]  = "Opens metrics"
...
L["comms"] = "Communications"
L["confirm_abort"] = "Are you certain you want to abort?"
L["confirm_adjust_player_points"] = "Are you certain you want to %s |cff33ff99%s|r |cFF87CEFA%s|r %s %s?"
L["confirm_award_item_to_player"] = "Are you certain you want to give %s to %s?"
L["confirm_decay"] = "Are you certain you want to decay |cFF87CEFA%s|r by |cff33ff99%d|r percent for %s?"
...
L["ep_min_desc"] = "The minimum EP required to be eligible for awards"
L["ep_victory"] = "The amount of EP to award when the boss is defeated"
L["equation"] = "Equation"
...
L["equipment_slots_help"] = "Configure the multiplier for each equipment slot, which is used in the calculation of GP (|cfffff468equipment_slot_multiplier|r)."
...
L["gp_tooltip_ilvl"] = "Level [%s] : %s"
L["gp_tooltip_gp"] = "GP [%s] : %s"
L["greater_than_min"] = "Greater than minimum"
L["g1"] = "g1"
L["g2"] = "g2"
L["high_king_maulgar"] = "High King Maulgar"
...
L["item_only_able_to_be_looted_by_you_bop"] = "The item can only be looted by you, but is not bind on pick up"
...
L["loot_options"] = "Looting Options"
L["loot_won"] = "Loot won"
...
L["quality_threshold_desc"] = "Only assign GP values for items at or above this quality. Also determines if GP values are displayed on item tool tips."
L["quantity"] = "Quantity"
L["raids"] = "Raids"
...
L["standby_open"] = "Open Standby/Bench Roster"
L["standby_open_desc"] = "Opens interface for managing the current standby/bench roster"
...
L["slot_multiplier_desc"] = "The GP multiplier applied for this equipment slot (|cfffff468equipment_slot_multiplier|r)"
...
L["whisperkey_minor_upgrade"] = "minorupgrade, minor, 2"
L["whisperkey_os_greed"] = "offspec, os, greed, 3"
