...
describe("Item Model", function()
	...
	describe("ItemRef", function()
		...
		it("provides transmission format", function()
			assert.equal(ItemRef(18832):ForTransmit(), "18832:2564:0:0:0:0:0:::0:0:0:0")
			assert.equal(ItemRef("18832"):ForTransmit(), "18832:2564:0:0:0:0:0:::0:0:0:0")
			assert.equal(ItemRef("|cff9d9d9d|Hitem:18832:2564:0:0:0:0:0:0:60:0:0:0:0|h[Brutality Blade]|h|r"):ForTransmit(), "18832:2564:0:0:0:0:0:::0:0:0:0")
			assert.equal(ItemRef("item:18832:2564:0:0:0:0:0:0:60:0:0:0:0"):ForTransmit(), "18832:2564:0:0:0:0:0:::0:0:0:0")
			assert.equal(ItemRef("item:18832:0:0:0:0:0:0::"):ForTransmit(), "18832:0:0:0:0:0:0")
			assert.equal(ItemRef("item:18832"):ForTransmit(), "18832")
			assert.equal(ItemRef("item:18832:"):ForTransmit(), "18832")
		end)
	end)
end)